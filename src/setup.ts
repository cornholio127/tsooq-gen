...
const DOCKER_IMAGE_TAG = '11.5-alpine';
...
const waitForDatabase = () => new Promise<void>((resolve, reject) => {
...
const runDatabaseScript = (script: (pool: Pool) => Promise<void>) => new Promise<void>((resolve, reject) => {
